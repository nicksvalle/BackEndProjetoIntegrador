...
class SubjectControllerTest {
    ...
    void getAllSubjects_ShouldReturnListOfSubjects_WhenSuccessful() throws Exception {
        ...
        // Act
        ResponseEntity<List<SubjectEntity>> response = subjectController.getAllSubjects();
    ...
    void getById_ShouldReturnSubject_WhenFound() throws Exception {
        ...
        // Act
        ResponseEntity<SubjectEntity> response = subjectController.getById(1L);
    ...
    void putSubject_ShouldReturnUpdatedSubject_WhenSuccessful() throws Exception {
        ...
        // Act
        ResponseEntity<SubjectEntity> response = subjectController.putSubject(updatedSubject, 1L);
